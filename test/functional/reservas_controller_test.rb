...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { cancha: @reserva.cancha, fdesde: @reserva.fdesde, fhasta: @reserva.fhasta, players: @reserva.players }
    end
  ...
  test "should update reserva" do
    put :update, id: @reserva, reserva: { cancha: @reserva.cancha, fdesde: @reserva.fdesde, fhasta: @reserva.fhasta, players: @reserva.players }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
